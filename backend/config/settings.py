...
SECRET_KEY = 'django-insecure-5z8@z#mo^xt2y9y)=67i!a1#a$z4pi560cu$oi&j9$ev@*9i_7'
...
GOOGLE_REDIRECT_URI = os.environ.get('GOOGLE_REDIRECT_URI', 'http://localhost:8000/api/crm/google/callback/')
