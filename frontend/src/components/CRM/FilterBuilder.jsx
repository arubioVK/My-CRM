...
const FilterBuilder = ({
    ...
    const [conditions, setConditions] = useState(initialView?.filters?.conditions?.map(c => ({ ...c, id: Math.random().toString(36).substr(2, 9) })) || initialFilters?.conditions?.map(c => ({ ...c, id: Math.random().toString(36).substr(2, 9) })) || [
        { id: Math.random().toString(36).substr(2, 9), field: defaultField, operator: 'icontains', value: '' }
    ]);
    ...
    const addCondition = () => {
        ...
        setConditions([...conditions, { id: Math.random().toString(36).substr(2, 9), field: defaultField, operator: defaultOp, value: '' }]);
    };
                    ...
                    <div key={cond.id} className="flex items-center space-x-3">
                        ...
                        <select
                            ...
                            onChange={(e) => {
                                ...
                                const newConds = conditions.map(c => {
                            ...
                            className="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm"
                        >
                            {(OPERATORS_BY_TYPE[fields.find(f => f.value === cond.field)?.type] || DEFAULT_OPERATORS).map((o, i) => (
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        const newVal = e.target.checked
                                                            ...
                                                            : currentVal.filter(v => v !== 'me');
                                                        updateCondition(cond.id, 'value', newVal);
                                                    }}
